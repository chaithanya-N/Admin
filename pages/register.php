...
<body class="bg-dark">
 <div class="container">
      ...
      <input class="form-control" name="email" id="email" type="email" aria-describedby="emailHelp" placeholder="Enter first name">
              <span id="email-error" class="error"> </span>
             <!-- <span style="color:red" id="emaile">Please enter valid email<span> -->
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Last name</label>
            <input class="form-control" id="password" type="password" placeholder="Enter Last name" name="password">
      ...
      <input class="form-control" name="email" id="email" type="email" aria-describedby="emailHelp" placeholder="Enter email">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="cpsw" type="password" placeholder="Enter Confirm Password" name="confirmpassword">
            <span id="pwd-error" class="error"> </span>
            <!-- <span style="color:red" id="pswe">Please enter password<span> -->
          </div>
          <div class="form-group">
